...
def grade(submission: pd.DataFrame, answers: pd.DataFrame) -> float:
    ...
    if "Class" not in submission.columns:
        raise InvalidSubmissionError("Submission must have a 'Class' column.")
    ...
    correct = (submission["Class"].values == answers["Class"].values).sum()
