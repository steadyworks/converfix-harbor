...
def clean_text(raw_text):
    ...
    tokens = [w for w in tokens if w in stop_words]
...
train_data["target"] = train_data["Category"].map({"ham": 1, "spam": 0})
...
X_test_tfidf = vectorizer.fit_transform(test_data["Cleaned_Message"])
