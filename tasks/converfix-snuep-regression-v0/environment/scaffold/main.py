...
test_user_ids = df_test['user_id'].copy().reset_index(drop=True)
...
X_test_final = df_test.drop(columns=['user_id']).sample(frac=1, random_state=42)
...
X_test_scaled = scaler_full.fit_transform(X_test_final)
