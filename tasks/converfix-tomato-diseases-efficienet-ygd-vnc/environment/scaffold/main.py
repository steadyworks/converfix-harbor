...
# Build ImageFolder structure from CSV (10 original classes)
...
IMAGE_SIZE = 128   # EfficientNetB0 supports 128x128
BATCH_SIZE = 32
CHANNELS = 3
EPOCHS = 15
...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.8, patience=2, verbose=1)
checkpoint = ModelCheckpoint('/tmp/best_efficientnetb0_model.keras',
...
plt.ylabel("Actual")
plt.title(f"Confusion Matrix - EfficientNetB0 ({n_classes} Classes)")
plt.show()
