...
The model extracts sentiment keywords but achieves very low Jaccard scores. It returns only a single word per tweet. The approach needs to be revised to capture full sentiment-bearing phrases.
